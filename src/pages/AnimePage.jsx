...
const AnimePage = () => {
    ...
    return (
        <div className='w-screen min-h-screen xl:px-36 2xl:px-60 lg:px-20 px-4 flex items-center'>
            <div className='grow shadow-xl w-full bg-white dark:bg-gray-950 rounded-xl flex flex-col py-10 px-4 md:px-20 relative'>
                <div className='flex flex-col md:flex-row gap-2 md:gap-10 grow'>
                    <div className='min-w-[200px] max-w-[200px] gap-4 min-h-full rounded-lg overflow-hidden flex flex-col justify-between'>
                        ...
                        <div onClick={() => {navigate(-1)}} className='flex gap-1 items-center cursor-pointer text-gray-800 dark:text-gray-300 hover:text-blue-500 transition-all'>
                    ...
                    <div className='flex flex-col grow gap-4'>
                        {!loading && data ? <h2 className='text-3xl text-center sm:text-left text-gray-800 dark:text-gray-300'>{data.title}</h2> : 
                        ...
                        <div className='mt-2'>
                            {!loading && data && <p className='font-light text-gray-700 dark:text-gray-500'>
                                {data.synopsis}
                            </p>}
